...
- icon: magic
  ...
  url: /slides/01-Intro-to-RMarkdown.html
---
...
3. https://andrewbtran.github.io/NICAR/2018/workflow/docs/02-rmarkdown.html

4. https://yihui.name/tinytex/ *(install!)*

5. https://github.com/rstudio/cheatsheets/blob/master/rmarkdown-2.0.pdf
