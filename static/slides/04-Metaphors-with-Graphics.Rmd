...
output:
  xaringan::moon_reader:
    css: ["default", "css/ohsu.css", "css/ohsu-fonts.css", "gentle-ggplot2.css"]
    lib_dir: libs
    nature:
...
```{r, ref.label='7a', echo=FALSE,message=FALSE,warning=FALSE, out.width="90%"}
```
]
...
.pull-right[
```{r, ref.label='8c', echo=FALSE,message=FALSE,warning=FALSE, out.width="90%"}
```
]
