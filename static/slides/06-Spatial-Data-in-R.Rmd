...
knitr::include_graphics("images/piece-of-map.png")
```
...
---
```{r, echo = FALSE, out.height="550px", out.width="900px"}
...
- Features = Geometries ( Location Data )
...
# So Finally, What is Spatial Data?
.pull-left[
...
.pull-left[
![](images/2book4.jpg){height=150px}
]
.pull-right[
![](images/2book18.jpg)
...
knitr::include_graphics("images/reg_cyl_proj.png")
```
...
knitr::include_graphics("images/oblq_cyl_proj.png")
```
]
...
```{r, echo=FALSE, out.height="450px", out.width="350px"}
knitr::include_graphics("images/polar_azi_proj.png")
```
]
...
```{r, echo=FALSE, out.height="450px", out.width="450px"}
knitr::include_graphics("images/oblq_azim_proj.png")
```
]
...
<iframe width="629" height="352" src="https://www.youtube.com/embed/vVX-PrBRtTY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
ggplot() + 
  ...
  coord_sf(crs = "+proj=laea +lat_0=23 +lon_0=77 +x_0=4321000 #<< +y_0=3210000 +ellps=GRS80 +units=m  +no_defs") #<<
