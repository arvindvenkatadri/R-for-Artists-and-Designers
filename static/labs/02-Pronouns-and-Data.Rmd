...
+------------+------------+------------+------------+------------+
| Pronoun    | Answer     | R Variable | Example    | What O     |
|            |            | / Scale    |            | perations? |
+============+============+============+:===========+============+
| What, Who, | Name,      | Qua        | Name       | -   Count  |
| Where,     | Place,     | litative / |            |     no. of |
| Whom,      | Animal,    | **N        |            |     cases  |
| Which      | Thing      | ominal**   |            | -   Mode   |
+------------+------------+------------+------------+------------+
| How, What  | A Manner / | Qua        | -   Soci   | -   Median |
| Kind, What | Method,    | litative / | o-economic | -   P      |
| Sort       | Type or    | **O        |     status |            |
|            | Attribute  | rdinal**   |     ("low  | ercentiles |
|            | from a     |            |     i      |            |
|            | list, with |            |     ncom   |            |
|            | list items |            | e","middle |            |
|            | in some    |            |            |            |
...
|            |            |            | like").    |            |
+------------+------------+------------+------------+------------+
| How Many / | Quantities | Quan       | -   pH     | -   Mean   |
| Much /     | with       | titative / | -   SAT    |            |
| Heavy?     | Scale.     | **In       |     score  | -          |
| Few?       |            | terval**   |            |   Standard |
| Seldom?    | **Dif      |            | (200-800), |            |
| Often?     | ferences** |            | -   Credit |            |
| When?      | are        |            |     score  |  Deviation |
|            | m          |            |            |            |
|            | eaningful, |            | (300-850). |            |
|            | but not    |            | -   Year   |            |
|            | products   |            |     of     |            |
...
+------------+------------+------------+------------+------------+
| How Many / | Q          | Quan       | -          | -   C      |
| Much /     | uantities, | titative / |    Weight, |            |
| Heavy?     | with Scale | Ratio\*\*  |            | orrelation |
| Few?       | and a Zero |            |    length, | -   Coeff  |
| Seldom?    | Value.     |            |     Height |     of     |
| Often?     |            |            | -   T      |            |
| When?      | D          |            | emperature | Variation  |
|            | ifferences |            |     in     |            |
|            | and        |            |     Kelvin |            |
|            | Ratio      |            | -   Enzyme |            |
|            | s/Products |            |            |            |
