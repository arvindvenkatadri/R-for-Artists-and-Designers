...
+-------------+-------------+-------------+-------------+-------------+
| Pronoun     | Answer      | R Variable  | Example     | What O p    |
|             |             | / Scale     |             | erations?   |
+=============+=============+=============+:============+=============+
...
|             | Thing       | ominal**    |             | -   Mode    |
+-------------+-------------+-------------+-------------+-------------+
| How, What   | A Manner /  | Qua         | -   Soci o  | -   Median  |
| Kind, What  | Method,     | litative /  |             | -   P       |
| Sort        | Type or     | **O         |   -economic |             |
|             | Attribute   | rdinal**    |             | e rcentiles |
|             | from a      |             | status      |             |
|             | list, with  |             | ("low i     |             |
|             | list items  |             | ncom e      |             |
|             | in some "   |             | ","middle   |             |
...
|             |             |             | like").     |             |
+-------------+-------------+-------------+-------------+-------------+
| How Many /  | Q uantities | Quan        | -   pH      | -   Mean    |
| Much /      | with Scale. | titative /  | -   SAT     |             |
| Heavy? Few? |             | **In        |     score   | -           |
| Seldom?     | **Dif f     | terval**    |             |    Standard |
| Often?      | erences**   |             | (20         |             |
| When?       | are m e     |             | 0-800), -   | Deviation   |
|             | aningful,   |             | Credit      |             |
|             | but not     |             | score       |             |
|             | products or |             |             |             |
|             | ratios      |             | (30         |             |
...
|             |             |             | College     |             |
+-------------+-------------+-------------+-------------+-------------+
| How Many /  | Q u         | Quan        | -   Weight, | -   C       |
| Much /      | antities,   | titative /  |             |             |
| Heavy? Few? | with Scale  | Ratio\*\*   |     length, | orr         |
| Seldom?     | and a Zero  |             |             | elation -   |
| Often?      | Value.      |             |     Height  | Coeff of    |
| When?       |             |             |             |             |
|             | D i         |             | -   T e     | Variation   |
|             | fferences   |             |             |             |
|             | and Ratio s |             |   mperature |             |
|             | /Products   |             |     in      |             |
|             | are m e     |             |             |             |
|             | aningful. ( |             | Kelvin      |             |
|             | e.g Weight  |             |             |             |
