...
+----------+-----------------+-----------------+----------------------+
| Pronoun  | Answer          | R Variable      | Example              |
|          |                 | Character       |                      |
+==========+=================+=================+======================+
| What,    | Name, Place,    | Qualitative /   | Name                 |
| Who,     | Animal, Thing   | **Nominal**     |                      |
| Where,   |                 |                 |                      |
| Whom,    |                 |                 |                      |
| Which    |                 |                 |                      |
+----------+-----------------+-----------------+----------------------+
| How,     | A Manner /      | Qualitative /   | -   Socio-economic   |
| What     | Method, Type or | **Ordinal**     |     status ("low     |
| Kind,    | Attribute from  |                 |     income","middle  |
| What     | a list, with    |                 |     income","high    |
| Sort     | list items in   |                 |     income")         |
|          | some            |                 |                      |
|          | "**order**" (   |                 | -   education level  |
|          | e.g. good,      |                 |     ("high           |
|          | better,         |                 |     scho             |
|          | improved,       |                 | ol","BS","MS","PhD") |
|          | best..)         |                 |                      |
|          |                 |                 | -   income level     |
|          |                 |                 |     ("less than      |
|          |                 |                 |     50K",            |
...
|          |                 |                 |     like").          |
+----------+-----------------+-----------------+----------------------+
| How Many | Quantities with | Quantitative /  | -   pH               |
| / Much / | Scale.          | **Interval**    |                      |
| Heavy?   |                 |                 | -   SAT score        |
| Few?     | **Differences** |                 |     (200-800),       |
| Seldom?  | are meaningful, |                 |                      |
| Often?   | but not         |                 | -   Credit score     |
| When?    | products or     |                 |     (300-850).       |
|          | ratios          |                 |                      |
|          |                 |                 | -   Year of Starting |
|          |                 |                 |     in College       |
+----------+-----------------+-----------------+----------------------+
| How Many | Quantities,     | Quantitative /  | -   Weight, length,  |
| / Much / | with Scale and  | **Ratio**       |     Height           |
| Heavy?   | a Zero Value.   |                 |                      |
| Few?     |                 |                 | -   Temperature in   |
| Seldom?  | Differences and |                 |     Kelvin           |
| Often?   | Ratios/Products |                 |                      |
| When?    | are meaningful. |                 | -   Enzyme activity, |
|          | ( e.g Weight )  |                 |     dose amount,     |
|          |                 |                 |     reaction rate,   |
|          |                 |                 |     flow rate,       |
|          |                 |                 |     concentration,   |
|          |                 |                 |                      |
...
more crystallized numbers.

[![Types of
Variables](images/Ratio%20Interval%20Ordinal%20Nominal.PNG)](https://psychology.okstate.edu/faculty/jgrice/psyc3214/Stevens_FourScales_1946.pdf)
...
Get hold of a new dataset that is available within any of the R packages
within:
...
1.  Use the PRIMM process to add comments, questions, inferences to this
    document, wherever you see YOUR TURN.

2.  Create a fresh RMarkdown and similarly analyse two datasets of the
    following data sets
