...
We will want to add a few fonts to our graphs. The best way (currently) is to use the `showtext` package ( which we loaded above) to bring into our work fonts from Google. To view and select the fonts you might want to work with, spend some time looking over:
...
```{r}
(gg4 <- gg3b + theme(plot.margin = margin(t = 25, r = 25, b = 10, l = 25))) 
