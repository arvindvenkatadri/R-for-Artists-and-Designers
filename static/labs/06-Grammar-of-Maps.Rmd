...
a) Using a rough longitude latitude info directly, or using a place name to search for the long/lat info. THIS WILL ALWAYS WORK if the NUMBERS ARE OK !!
...
`bbox_2` and `bbox_3` are identical and also reasonably sized: 0.04 degrees in longitude range and in latitude range.
