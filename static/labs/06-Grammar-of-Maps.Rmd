...
OK, `my area` is small and contained inside my `bbox`. So zoom works. Now to convert `my_area` into a spatial dataframe using `sf` and add it to the `blr_map` plot:
