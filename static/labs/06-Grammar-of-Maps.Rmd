...
Yes, the `write_sf(dat_H)` does not seem to work. This is something we need to research and understand. But atleast all the other files are saved locally. We will comment it out for now!
