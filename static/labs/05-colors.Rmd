...
subtitle: "Palettes from Famous Paintings, GoT, and Wes Anderson"
...
```{r Pengiuns default simple plot}
p1 <- penguins %>% 
  drop_na() %>% 
...
```{r Continuous Two Colour Gradients}
p2 +
...
```{r Continuous Three Colour Gradients}
...
```{r Continuous n-Colour Gradients - grDevices}
# grDevices Palettes
p2 +
...
```{r Applying RColorBrewer palettes to Base Plot}
p1 +
