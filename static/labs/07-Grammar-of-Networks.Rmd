...
the edge list **must** have "from" and "to" columns. The function also plots the labels for the nodes, using the names of the cities from the "label" column in the node list.
...
Download these two CSV files and save in your R Work folder.
Import these into your RMarkdown as follows:

airline_nodes <- read_delim("AIRLINES-EDGES.csv", 
    delim = ";", escape_double = FALSE, trim_ws = TRUE)
                                                                        airline_edges <- read_delim("AIRLINES-EDGES.csv", 
    delim = ";", escape_double = FALSE, trim_ws = TRUE)
...
-   Use the `gnodes` and `gedges` data to create your Game of Thrones network graph
- see if you can filter
