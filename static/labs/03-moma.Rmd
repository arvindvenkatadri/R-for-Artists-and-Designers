...
Note! This is not the original data- a lot of cleaning and pre-processing has been done on it by Alison Hill(@apreshill on Twitter). The below contains only paintings and drawings in the MoMA collection.

[http://bit.ly/cs631-moma](http://bit.ly/cs631-moma):


The cleaned data is called `artworks-cleaned.csv`, and stored it in a folder called `data`. You can use this code if you want to read in the local CSV file.
